...
- [x] Complete a massive wearable quality pass: all 86 non-empty choices have now been rebuilt/reviewed in current-runtime idle front/side evidence, including 20 hairstyles, full colors, genuinely unclothed `None` states, waist bridge, held alignment, and improved preview framing. The retained audit is `docs/AVATAR-CATALOG-ADVERSARIAL-REVIEW-2026-07-31.md`. Closed 2026-08-03 on the user's acceptance from live play ("wearables are fine"); the rear/profile action-evidence matrix was waived rather than captured.
