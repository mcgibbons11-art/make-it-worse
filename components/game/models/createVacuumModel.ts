...
export function createApartmentCanisterVacuumModel(options: ProceduralModelOptions = {}): THREE.Group {
  ...
  const mesh_vacuum_hose_5Geometry = endpoint_vacuum_hose_5
    ...
    : buildTubeGeometry({"points": [[-0.2631, 0.1985, 0.2208], [-0.2976, 0.2035, 0.2497], [-0.2924, 0.2485, 0.3247], [-0.2168, 0.2885, 0.4078], [-0.0976, 0.2985, 0.4593], [0.0162, 0.2785, 0.4637], [0.0845, 0.2085, 0.4348], [0.1038, 0.1285, 0.3875], [-0.075, 0.0877, 0.3744]], "radius": 0.0577, "radialSegments": 8, "closed": false});
  ...
  const mesh_vacuum_nozzle_6Geometry = endpoint_vacuum_nozzle_6
    ...
    : buildExtrudeGeometry({"points": [[0.22715, -0.05185], [0.22715, 0.05185], [0.17715, 0.10185], [-0.17715, 0.10185], [-0.22715, 0.05185], [-0.22715, -0.05185], [-0.17715, -0.10185], [0.17715, -0.10185]], "depth": 0.0615, "axis": "y", "axisOffset": 0.0, "holes": [[[0.14205, -0.07685], [0.14205, -0.05415], [-0.14205, -0.05415], [-0.14205, -0.07685]]]});
